...
5. [言語・実行環境の可搬性設計](docs/architecture/language-and-platform-portability.md) — 言語・OS差異、依存方向、workspace UX、可搬性
...
| [言語・実行環境の可搬性設計](docs/architecture/language-and-platform-portability.md) | LanguageProfile、HostPlatform、複数言語UX、異種OS間の可搬性 | MVP対応環境の実装設計 |
...
- 言語・OS差異の境界、複数言語workspace UX、異種OS間の可搬性は、[言語・実行環境の可搬性設計](docs/architecture/language-and-platform-portability.md)を参照します。
