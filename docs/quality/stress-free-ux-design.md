...
- [concept.md「システムアーキテクチャ・技術スタック」](../product/concept.md#2-システムアーキテクチャ技術スタック)
- [concept.md「解答言語と設定管理」](../product/concept.md#4-解答言語と設定管理)
...
- [concept.md「CLIコマンド構成」](../product/concept.md#6-cliコマンド構成)
...
- [concept.md「ディレクトリ構成」](../product/concept.md#5-ディレクトリ構成ハイブリッド型)
- [concept.md「CLIコマンド構成」](../product/concept.md#6-cliコマンド構成)
...
- [concept.md「プロジェクトの目的」](../product/concept.md#1-プロジェクトの目的)
...
- [concept.md「エディタ非依存」](../product/concept.md#31-エディタ非依存)
