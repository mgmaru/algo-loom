...
6. submitの部分成功と再確認を設計する。
7. AtCoder認証の初回・期限切れ導線を設計する。
8. P0の利用者検証を行う。
9. P1の待機、確認、診断、用語を改善する。
10. Coreが安定した後にAI、同期、catalog、ViewerのP2を検証する。MVPの完了範囲は[MVPスコープ](../product/mvp.md)を正とする。
